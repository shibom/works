...
%   Compare the most recent saved correlation maps at pixel positions
%   input args include:
%       folder where the correlation files are saved
%       pixel positions 
%   i.e:
%       compare_recent('.',[20 50 100 150])
%   will find the most recently saved correlations for class0 and class1
